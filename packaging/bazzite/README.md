...
```text
packaging/bazzite/out/bc250-control-center-1.18.2-*.noarch.rpm
```

## Install the generated RPM

```bash
sudo rpm-ostree install ./packaging/bazzite/out/bc250-control-center-1.18.2-*.noarch.rpm
systemctl reboot
```
...
```bash
file packaging/bazzite/out/bc250-control-center-1.18.2-*.noarch.rpm
rpm -qip packaging/bazzite/out/bc250-control-center-1.18.2-*.noarch.rpm
sha256sum packaging/bazzite/out/bc250-control-center-1.18.2-*.noarch.rpm
```
