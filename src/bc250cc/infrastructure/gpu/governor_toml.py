...
from bc250cc.domain.gpu.voltage_profiles import (
    ...
    OBERON_FREQUENCY_MAX_MHZ,
    OBERON_FREQUENCY_MIN_MHZ,
    OBERON_SAFE_VOLTAGE_MAX_MV,
    OBERON_SAFE_VOLTAGE_MIN_MV,
    VOLTAGE_BOOST_START_MHZ,
)
from bc250cc.domain.gpu.voltage_profiles import (
    SUPPORTED_VOLTAGE_LEVELS as SUPPORTED_VOLTAGE_LEVELS,
)
from bc250cc.domain.gpu.voltage_profiles import (
...
def voltage_profile(level: int) -> dict[int, int]:
    ...
    try:
        return _voltage_profile(level)
    except ValueError as error:
        raise GovernorTomlError(str(error)) from error
