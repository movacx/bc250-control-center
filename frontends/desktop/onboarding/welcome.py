...
from ..i18n import LANGUAGE_OPTIONS, language_name, system_language, tr
...
class WelcomeOverlay(QWidget):
    ...
    def _step_labels() -> tuple[str, ...]:
        return (tr("Language"), tr("Appearance"), tr("Sidebar"), tr("Guided tour"))
    ...
    def _dress_scrollbar(self) -> None:
        ...
        self.language_scrollbar.setStyleSheet(
